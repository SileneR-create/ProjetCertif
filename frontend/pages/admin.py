...
def get_search_stats() -> dict:
    ...
    top_months = [{"mois": month_names.get(r[0], str(r[0])), "recherches": r[1]}
                  for r in months_raw]
...
def get_favorites_stats() -> dict:
    ...
    """)
    top_cities = [{"city": r[0], "country": r[1] or "", "favoris": r[2]}
                  for r in c.fetchall()]
    ...
    top_months = [{"mois": month_names.get(r[0], str(r[0])), "favoris": r[1]}
                  for r in c.fetchall()]
    ...
    with tab_overview:
        ...
        with col1:
            ...
            if u_stats["signups_by_day"]:
                ...
                fig = px.area(df_signup, x="date", y="inscriptions",
        ...
        with col2:
            ...
            if s_stats["searches_by_day"]:
                ...
                fig = px.area(df_search, x="date", y="recherches",
    ...
    with tab_searches:
        ...
        with col1:
            ...
            if s_stats["top_destinations"]:
                ...
                fig = px.bar(df_dest, x="recherches", y="city",
                             orientation="h",
                             color="recherches",
                ...
                fig.update_layout(
                    ...
                    paper_bgcolor='rgba(0,0,0,0)',
                    plot_bgcolor='rgba(0,0,0,0)',
                    height=350, font=dict(family='Outfit')
                )
                st.plotly_chart(fig, use_container_width=True)
            else:
        ...
        with col2:
            ...
            if s_stats["top_months"]:
                ...
                fig = px.bar(df_months, x="mois", y="recherches",
                             color="recherches",
    ...
    with tab_favs:
        ...
        with col1:
            ...
            if f_stats["top_cities"]:
                ...
                fig = px.bar(df_cities, x="favoris", y="label",
                             orientation="h",
                             color="favoris",
        ...
        with col2:
            ...
            if f_stats["top_months"]:
                ...
                fig = px.pie(df_fav_months, names="mois", values="favoris",
    ...
    with tab_users:
        ...
        if search_query:
            users = [u for u in users if
                     search_query.lower() in u["username"].lower() or
            ...
            with st.expander(
                ...
                with c4:
                    if not is_current:
                        ...
                        if st.button(admin_label, key=f"admin_{u['id']}",
                        ...
                        if st.session_state.get(f"confirm_del_{u['id']}"):
                            ...
                            with cc1:
                                if st.button("✅ Confirmer", key=f"confirm_yes_{u['id']}",
                                             type="primary"):
                                    delete_user(u["id"])
